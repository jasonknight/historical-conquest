<table width="100%">
    <?php 
        ...
        $headers = array_filter($headers,function ($h) {
            return !in_array($h,['created_at','updated_at','summary','background_image','background_color','border_color','text_color','illustration','when_to_play','reference','reference2','climate']); 
        });
    ?>
    <tr>
